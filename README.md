<h1 align="center"><b> 𖢵 ᴀʅσηҽ χ мυѕι¢ 𖢵 </b></h1>

<img src="https://readme-typing-svg.herokuapp.com?color=F77247&width=420&lines=𝙰+𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖+Music+Totla+𝚂𝚘𝚞𝚛𝚌𝚎;𝚠𝚛𝚒𝚝𝚝𝚎𝚗+𝙸𝚗+Python+BY+@AloneXBots%E2%9D%A4%EF%B8%8F">

</p>

_**ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ ᴀs [ᴀʅσηҽ χ мυѕι¢ ](https://t.me/AloneXMusicBot)**_
...
<p align="center">
    <a href="https://github.com/AloneXBot/AloneX"> <img src="https://img.shields.io/github/repo-size/AloneXBot/AloneX?color=orange&logo=github&logoColor=green&style=for-the-badge" /></a>
    <a href="https://github.com/AloneXBot/AloneX/commits/prince"> <img src="https://img.shields.io/github/last-commit/AloneXBot/AloneX?color=brown&logo=github&logoColor=green&style=for-the-badge" /></a>
    <a href="https://github.com/AloneXBot/AloneX/issues"> <img src="https://img.shields.io/github/issues/AloneXBot/AloneX?color=blueviolet&logo=github&logoColor=green&style=for-the-badge" /></a>
    <a href="https://github.com/AloneXBot/AloneX/network/members"> <img src="https://img.shields.io/github/forks/AloneXBot/AloneX?color=red&logo=github&logoColor=green&style=for-the-badge" /></a>  
    <a href="https://pypi.org/project/Telethon/"> <img src="https://img.shields.io/pypi/v/telethon?color=yellow&label=telethon&logo=python&logoColor=green&style=for-the-badge" /></a>
</p>

> ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴠɪsɪᴛɪɴɢ ʜᴇʀᴇ ᴀɴᴅ ᴀʟsᴏ sᴜᴘᴘᴏʀᴛɪɴɢ [ᴛᴇᴀᴍ ᴀʟᴏɴᴇ](https://t.me/AloneXBots) .ᴀʟsᴏ ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴀᴛ [sᴜᴘᴘᴏʀᴛs](https://t.me/AlonesHeaven) ғᴏʀ ᴇᴅɪᴛɪɴɢ.


## sᴘᴇᴄɪᴀʟ ғᴇᴀᴛᴜʀᴇs || ᴄᴏᴍᴍᴀɴᴅs || ᴅᴇᴘʟᴏʏᴍᴇɴᴛ ᴀᴅᴅᴇᴅ ʙʏ ᴛᴇᴀᴍ ᴀʟᴏɴᴇ
...
<details>
<summary><b>ᴀʟᴏɴᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs</b></summary>
<br>
    
- `/ping`or `/zinda` - ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ ɪs ᴀʟɪᴠᴇ.
- `/start` or `/Alone` - sᴛᴀʀᴛs ᴛʜᴇ ᴍᴜsɪᴄ ʙᴏᴛ.
- `/help` or `/Alonehelp` - ɢᴇᴛ ʜᴇʟᴩ ᴍᴇɴᴜ ᴡɪᴛʜ ᴇxᴩʟᴀɴᴀᴛɪᴏɴ ᴏғ ᴄᴏᴍᴍᴀɴᴅs.
...
- `/stats` or `/AloneXBots` - sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛs ᴏғ ᴛʜᴇ ʙᴏᴛ
- `/lang` or `/language` or `/langs` - ᴛᴏ ᴄʜᴀɴɢᴇ ᴛʜᴇ ʟᴀɴɢᴜᴀɢᴇ ғʀᴏᴍ ᴀʟᴏɴᴇ
 </details>
...
<details>
<summary><b>ᴀʟᴏɴᴇ ᴍᴀɴᴅᴀᴛᴏʀʏ ᴠᴀʀs</b></summary>
<br>

- These are the minimum required vars need to setup to make Alone Music Bot functional.

1. `API_ID` : Get it from my.telegram.org 
2. `API_HASH`  : Get it from my.telegram.org 
3. `BOT_TOKEN` : Get it from [@Botfather](http://t.me/BotFather) in Telegram
4. `MONGO_DB_URI` : Get mongo db [from here.](https://notreallyshikhar.gitbook.io/AloneXMusic/deployment/mongodb)
5. `LOG_GROUP_ID` : You'll need a Private Group ID for this. Supergroup Needed with id starting from -100 
6. `MUSIC_BOT_NAME` : A name for your Music bot.
7. `OWNER_ID` : Your Owner ID for managing your bot.
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@AloneStringBot](http://t.me/AloneStringBot) in Telegram.
</details>
    
<details>
<summary><b>ᴀʟᴏɴᴇ ɴᴏɴ-ᴍᴀɴᴅᴀᴛᴏʀʏ ᴠᴀʀs</b></summary>
<br>
...
<details>
<summary><b>ᴀʟᴏɴᴇ ʙᴏᴛ ᴠᴀʀs</b></summary>
<br>
...
- You can play tracks or playlists from spotify from Alone Music bot
- You'll need these two vars to make spotify play working. This is not essential , you can leave them blank if you want.

### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/AloneXMusic/deployment/spotify)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/AloneXMusic/config-vars/heroku-vars)
...
- If you plan to use Alone Music Bot with your own customized or modified code.
...
<details>
<summary><b>ᴀʟᴏɴᴇ ɪᴍᴀɢᴇs/ᴛʜᴜᴍʙɴᴀɪʟ ᴠᴀʀs</b></summary>
<br>

- You can change images which are used in Alone Music Bot.
- You can generate telegaph links from [@AloneTelegraphBot](http://t.me/AloneTelegraphBot) and use it here.
...
<details>
<summary><b>ᴀʟᴏɴᴇ ᴍᴜʟᴛɪ ᴀssɪsᴛᴀɴᴛ ᴍᴏᴅᴇ</b></summary>
<br>

- You can use upto 5 Assistant Clients ( allowing your bot to atleast work in 2000-2500 chats at a time )

1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@AloneStringBot](http://t.me/AloneStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@AloneStringBot](http://t.me/AloneStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@AloneStringBot](http://t.me/AloneStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@AloneStringBot](http://t.me/AloneStringBot) in Telegram.
</details>

### ᴀʟᴏɴᴇ ᴍᴜʟᴛɪ-ʟᴀɴɢᴜᴀɢᴇ sᴜᴘᴘᴏʀᴛ 🙈

<details>
<summary><b>ᴀʟᴏɴᴇ ᴍᴜʟᴛɪ-ʟᴀɴɢᴜᴀɢᴇ</b></summary>
<br>
...
|-|-------|-------|
| en | ᴀʟᴏɴᴇ  | Thanks to [AloneXBots](https://t.me/AloneXBots)
...
You can edit [`en.yml`](https://github.com/AloneXBots/AloneXMusic/blob/master/strings/langs/en.yml) present in langs folder to your own language and send us the edited file at [AloneSupport](https://t.me/AlonesHeaven)
...
<br>
ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴅᴇᴘʟᴏʏ ᴀʟᴏɴᴇ ᴍᴜsɪᴄ ᴏɴ sᴄᴀʟɪɴɢᴏ ɪɴᴛʀᴏᴅᴜᴄᴇᴅ ʙʏ 
        
<p align="center"><a href="https://my.scalingo.com/deploy?template=https://github.com/AloneXBot/AloneX"> <img src="https://cdn.scalingo.com/deploy/button.svg" width="220" height="38.45"/></a></p>
...
<p><a href="https://telegram.dog/Alonexstringbot"><img src="https://img.shields.io/badge/TG%20String%20Gen%20Bot-blueviolet?style=for-the-badge&logo=appveyor" width="200""/></a></p>
...
<h4> ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴅᴇᴘʟᴏʏ AloneXMusic ᴏɴ ʜᴇʀᴏᴋᴜ</h4> 
   
<p><a href="https://dashboard.heroku.com/new?template=https://github.com/AloneXBot/AloneX"><img src="https://img.shields.io/badge/Deploy%20To%20Heroku-red?style=for-the-badge&logo=heroku" width="200"/></a></p>
</details>
...
- Get your [Necessary Variables](https://github.com/AloneXBots/AloneXMusic/blob/master/sample.env)
...
`git clone https://github.com/AloneXBots/AloneXMusic && cd AloneXMusic`
...
|-|-------|-------|
| 1. | 「 ᴛᴇᴀᴍ ☯︎ ᴀʟᴏɴᴇ 」 | ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ [⍟ ᴛᴇᴀᴍ ᴀʟᴏɴᴇ ⍟](https://t.me/AloneXBots)  ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ
| 2. | 𝐃𝐌 𝐀𝐋𝐎𝐍𝐄 | ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ [⋗ ʙɪʟʟᴜ ⋖](https://t.me/ALONE_WAS_BOT) & [ʜɪs sᴜᴘᴘᴏʀᴛ](https://t.me/AlonesHeaven)  ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ
| 3. | 💖⃝͢ʏᴜᴋᴋɪ➻❥⃟💞ﮩﮩ٨࿐ | Thanks to [TeamYukki](https://t.me/TeamYukki)
| 4. | ᴘʏʀᴏɢʀᴀᴍ & ᴘʏ-ᴛɢᴄᴀʟʟs| Thanks to [ᴘʏʀᴏɢʀᴀᴍ](https://github.com/pyrogram/pyrogram) & [ᴘʏ-ᴛɢᴄᴀʟʟs](https://github.com/pytgcalls/pytgcalls)
</details>
...
# ❤️ Support<
<a href="https://telegram.dog/AloneXBots"><img src="https://img.shields.io/badge/Join-Team%20Alone-red.svg?logo=Telegram"></a>
<a href="https://telegram.dog/Aloneupdates"><img src="https://img.shields.io/badge/Join-Alone%20Updates-red.svg?logo=Telegram"></a>
<a href="https://telegram.dog/Alonesupports"><img src="https://img.shields.io/badge/Join-Alone%20Supports-blue.svg?logo=telegram"></a>
...
![Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=AloneXBots&theme=github_dark&layout=compact&exclude_repo=AloneXMusic.AloneId-AI.Shayachatbot.tag-all-bot.Aloneban-all)
